...
builder.Services.AddScoped<ObtenerMontosFacturacionCasoDeUso>();
builder.Services.AddScoped<ObtenerDesgloseEstadoFacturacionCasoDeUso>();
builder.Services.AddScoped<ObtenerEvolucionFacturacionCasoDeUso>();
...
builder.Services.AddScoped<EliminarBorradorDocumentoElectronicoCasoDeUso>();
