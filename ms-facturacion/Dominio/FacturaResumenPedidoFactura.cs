...
public sealed record FacturaResumenPedidoFactura(
    int IdDocumentoElectronico, string NumeroFactura, string TipoDocumentoTexto, string? DocumentoAfectado,
    string ClienteNombre, DateOnly FechaEmision, string FormaPagoCodigo, decimal TotalImporte, string MonedaIcono,
    string EstadoCodigo, string ColorLetra, string ColorFondo);
